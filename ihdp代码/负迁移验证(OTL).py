...
N_REPEATS = 10
DEFAULT_N_JOBS = 1
DEFAULT_OUTPUT_DIR = "ihdp_bad_otl_no_share_outputs"
...
def resolve_source_path(source_dir: str, target_env_info: Dict[str, object], tag: str = "good") -> str:
    ...
    # ==============================================================
    source_filename = target_filename.replace("ihdp_", "ihdp_good_")
...
def main() -> None:
    ...
    target_data_dir = args.target_data_dir or resolve_data_dir([
        "ihdp_ethos_streams_repeats10_target",

    ])
    good_source_dir = args.good_source_dir or resolve_data_dir([
        "ihdp_bad_ethos_streams_repeats10_source",
