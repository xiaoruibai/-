...
N_REPEATS = 10
DEFAULT_N_JOBS = 1
DEFAULT_OUTPUT_DIR = "ihdp_bad_l1_tldr_fixed_window100_preq_outputs"
...
def main() -> None:
    ...
    good_source_dir = args.good_source_dir or resolve_data_dir(["ihdp_bad_ethos_streams_repeats10_source"])
