# -*- coding: utf-8 -*-
"""
Twins-style offline TL baseline with fairer prequential block evaluation.
...
N_REPEATS = 10
DEFAULT_N_JOBS = 1
DEFAULT_OUTPUT_DIR = "twins_l1_tldr_fixed_window100_preq_outputs"
...
DEFAULT_LAMBDA_IPW = 0.1
DEFAULT_LAMBDA_OR = 0.01
DEFAULT_LAMBDA_DR = 0.01
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Twins offline TL with fixed-window prequential evaluation using oracle p/q")
...
def resolve_source_path(source_dir: str, target_env_info: Dict[str, object], tag: str = "good") -> str:
    ...
    source_filename = target_filename.replace("twins_", "twins_good_") if tag == "good" else target_filename.replace("twins_", "twins_good_")
...
def main() -> None:
    ...
    target_data_dir = args.target_data_dir or resolve_data_dir(["twins_ethos_streams_repeats10_target"])
    good_source_dir = args.good_source_dir or resolve_data_dir(["twins_ethos_streams_repeats10_source"])
