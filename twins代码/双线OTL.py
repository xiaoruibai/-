...
推荐：
python 双线OTL.py --n-repeats 50 --n-jobs 1
"""
...
def resolve_source_path(source_dir: str, target_env_info: Dict[str, object], tag: str = "good") -> str:
    ...
    # ==============================================================
    prefix_candidates = ["twins_good_", f"twins_{tag}_", "twins_source_"]
    for prefix in prefix_candidates:
        source_filename = target_filename.replace("twins_", prefix, 1)
...
def build_data_diagnostic_row(env_info: Dict[str, object], target_path: str, source_path: str, source_profile: str) -> Dict[str, object]:
    ...
    row["same_covariate_support_note"] = (
        "Twins semi-synthetic streams share the same covariate support; this diagnostic quantifies whether this repeat also uses the same source_row order."
    )
    return row
